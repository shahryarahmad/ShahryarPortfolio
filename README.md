...
🚀 **[Dev Portfolio V2 has arrived. Meet Devfolio, a modern portfolio + blog template built with GatsbyJS and TailwindCSS]** 🚀
...
To view a live demo, [click here](https://shahryarahmad.github.io/ShahryarPortfolio/).
...
```HTML
<form method="POST" action="https://formspree.io/shahryardeveloper@gmail.com">
